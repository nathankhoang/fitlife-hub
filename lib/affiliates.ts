...
export const affiliateProducts: Record<string, AffiliateProduct> = {
  ...
  "orgain-organic-protein": {
    ...
    url: amz("B00J074W7Q"),
    source: "amazon",
    imageUrl: img("orgain-organic-protein", "svg"),
  },
  "quest-protein-bars": {
    ...
    url: amz("B08DXQZ8F6"),
    source: "amazon",
    imageUrl: img("quest-protein-bars", "svg"),
  },
  "rxbar-protein-bars": {
    ...
    url: amz("B07P8MKN3T"),
    source: "amazon",
    imageUrl: img("rxbar-protein-bars", "svg"),
  },
  ...
  "fish-oil-nordic-naturals": {
    ...
    url: amz("B002CQU564"),
    source: "amazon",
    imageUrl: img("fish-oil-nordic-naturals", "svg"),
  },
  "vitamin-d3-sports-research": {
    ...
    url: amz("B01B5BCCAY"),
    source: "amazon",
    imageUrl: img("vitamin-d3-sports-research", "svg"),
  },
  "magnesium-glycinate": {
    ...
    url: amz("B000BD0RT0"),
    source: "amazon",
    imageUrl: img("magnesium-glycinate", "svg"),
  },
  "ashwagandha-ksm66": {
  ...
  "yoga-mat-budget": {
    ...
    url: amz("B078K19Q6X"),
    source: "amazon",
    imageUrl: img("yoga-mat-budget", "svg"),
  },
  "ab-roller": {
    id: "ab-roller",
  ...
  "push-up-handles": {
    ...
    url: amz("B00006IUWB"),
    source: "amazon",
    imageUrl: img("push-up-handles", "svg"),
  },
  ...
  "food-scale-etekcity": {
    ...
    url: amz("B0113UZJE2"),
    source: "amazon",
    imageUrl: img("food-scale-etekcity", "svg"),
  },
  "nutribullet-blender": {
