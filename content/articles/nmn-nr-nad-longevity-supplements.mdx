...
- Human trials confirm oral NMN doses of 300–900 mg/day reliably raise blood NAD+ levels; an early NIH-sponsored NR trial showed roughly a doubling of whole-blood NAD+ after just two weeks.
- Blood NAD+ rising does not equal tissue NAD+ rising — the landmark Yoshino 2021 Science paper improved muscle insulin sensitivity without detecting any increase in muscle NAD+, meaning the mechanism is more complex than the marketing suggests.
- A 2024 meta-analysis of 10 NMN RCTs (n = 437) found non-significant improvements in physical performance overall, and concluded that "an exaggeration of the benefits of NMN supplementation may exist in the field."
- NR and NMN produce equivalent evidence quality for healthy adults; NR costs ~$40–80/month versus ~$60–120/month for NMN, and NR carries clearer FDA regulatory standing (GRAS status via TruNiagen).
- The strongest human signals exist for specific populations: the NICE trial showed meaningful walking distance improvement in peripheral artery disease patients on NR, and Yoshino 2021 showed insulin sensitivity gains in middle-aged adults with overweight.
- No human trial has run long enough to measure hard longevity endpoints (cardiovascular events, cognitive decline, all-cause mortality) — every positive result to date is a surrogate biomarker or short-duration functional outcome.
