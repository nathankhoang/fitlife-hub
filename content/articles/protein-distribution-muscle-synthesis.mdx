...
- Distributing 30–40g of protein across 4 meals (spaced 3–5 hours apart) produces roughly 20–30% greater 24-hour MPS rates compared to skewed or bolus dosing patterns (Areta et al., 2013; Mamerow et al., 2014)
- A minimum leucine threshold must be hit per meal — roughly 0.25–0.40 g/kg body weight — to robustly activate mTORC1 and trigger MPS; doses below this threshold produce no meaningful anabolic response
- The "muscle full" effect limits MPS to a 2–2.5 hour window per dose; amino acids circulating beyond that window are oxidized, not converted to muscle tissue
- Evenly distributing protein across 3 meals raises 24-hour mixed MPS by 25% versus the common pattern of eating most protein at dinner (Mamerow et al., 2014)
- Short-term intermittent fasting does not impair MPS when total daily protein is maintained — the compressed eating window matters less than hitting the daily target (Williamson et al., 2024, *Clinical Nutrition*)
- Consuming 30–40g of casein protein 30 minutes before sleep elevates overnight MPS by approximately 22%, making pre-sleep protein one of the highest-leverage single-dose interventions regardless of overall distribution strategy (van Loon et al.)
